...
CASE WHEN POS_NOTAS_TOTAIS.STATUS = 'C' THEN 0 ELSE 1 END AS ST_VD,
case when POS_NOTAS_TOTAIS.ID_CLIENTE like '%f%' then 0 else POS_NOTAS_TOTAIS.ID_CLIENTE end AS CD_CLI,
